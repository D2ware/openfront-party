...
(function (global) {
  ...
  // Verified against the serving deployment and a captured public lobby frame.
  const SCHEMA_REV = "1e973bb534b8b37d8d30c80ab27ad1391a7b82da";
  ...
  const PublicLobbyFull = obj([
    ...
    // Optional fields still allocate header bits when absent.
